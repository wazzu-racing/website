...
<svelte:head>
	<title>Donate — Wazzu Racing</title>
	<meta
		name="description"
		content="Support Wazzu Racing — Washington State University's Formula SAE team. Learn how to donate, sponsor, or give in-kind to support student engineers."
	/>
</svelte:head>
